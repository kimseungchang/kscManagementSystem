...
public class BusanWorker extends Worker implements WorkerInput{//getUserInput 파트에 접근하려면 WorkerInput을 가지고 WorkerManagement에서 접근 가능
	
	public BusanWorker(Workerlocation location) {// Worker 생성자 선언
